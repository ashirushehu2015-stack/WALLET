        ...
        {screen === "welcome" && (
          <div className="flex-1 bg-[#0A7A4B] text-white flex flex-col justify-between p-8 text-center relative overflow-hidden">
            ...
            <div className="flex-1 flex flex-col items-center justify-center">
              ...
              <div className="w-24 h-24 rounded-[28px] overflow-hidden shadow-2xl mb-8 border-4 border-white/30 bg-white flex items-center justify-center relative">
                <img
                ...
                />
                <span className="text-5xl font-black text-[#0A7A4B] tracking-tighter absolute">M</span>
              </div>
